...
pos[2] = target qubit. """
function Cnot!(qc::QC, pos; update_rep=true)
...
function CRn!(qc::QC, n, pos; update_rep=true)
...
function Swap!(qc::QC, pos; update_rep=true)
...
function Fredkin!(qc::QC, pos; update_rep=true)
...
CURRENTLY NOT IMPLEMENTED!"""
function SqrtSwap!(qc::QC, control_qubits, action_qubits; update_rep=true, β=1/2)
...
arbitrary number of control qubits.
CURRENTLY NOT IMPLEMENTED!"""
function GeneralSwap!(qc::QC, control_qubits, action_qubits; update_rep=true, β=1/2)
...
qubits can be given. """
function C_Hadamard!(qc::QC, control_qubits, pos; update_rep=true)
...
in every position specified in the array pos; an arbitrary number of control
qubits can be given. """
function C_PauliX!(qc::QC, control_qubits, pos; update_rep=true)
...
in every position specified in the array pos; an arbitrary number of control
qubits can be given. """
function C_PauliY!(qc::QC, control_qubits, pos; update_rep=true)
...
in every position specified in the array pos; an arbitrary number of control
qubits can be given. """
function C_PauliZ!(qc::QC, control_qubits, pos; update_rep=true)
...
in every position specified in the array pos; an arbitrary number of control
qubits can be given. """
function C_SqrtX!(qc::QC, control_qubits, pos; update_rep=true)
...
in every position specified in the array pos; an arbitrary number of control
qubits can be given. """
function C_SGate!(qc::QC, control_qubits, pos; update_rep=true)
...
in every position specified in the array pos; an arbitrary number of control
qubits can be given. """
function C_TGate!(qc::QC, control_qubits, pos; update_rep=true)
...
function C_RxGate!(qc::QC, control_qubits, pos, θ::Number; update_rep=true)
...
- θ: rotation angle.
- update_rep: save graphical representation of gate. """
function C_RyGate!(qc::QC, control_qubits, pos, θ::Number; update_rep=true)
...
- θ: rotation angle.
- update_rep: save graphical representation of gate. """
function C_RzGate!(qc::QC, control_qubits, pos, θ::Number; update_rep=true)
...
- θ: phase angle.
- update_rep: save graphical representation of gate. """
function C_PhaseShift!(qc::QC, control_qubits, pos, θ::Number; update_rep=true)
...
- θ: phase angle.
- update_rep: save graphical representation of gate. """
function C_Rn!(qc::QC, control_qubits, pos, n::Number; update_rep=true)
...
Parameters:
- update_rep: save graphical representation of gate. """
function C_UGate!(qc::QC, U, control_qubits, pos; update_rep=true)
